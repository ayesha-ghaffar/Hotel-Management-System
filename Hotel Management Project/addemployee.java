...
public class addemployee extends JFrame implements ActionListener {
    ...
    addemployee(){
        ...
        String jobs[] = {"Reception","Housekeeping","Kitchen Staff","Room Service","Waiter/Waitress","Accountant","Chef"};
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        try{
           ...
           Connection connection = c.getConnection();
            PreparedStatement pstmt = connection.prepareStatement("INSERT INTO STAFF (StaffID, FirstName,LastName, Age, Gender, Salary, Contactno,JobTitle,HireDate,DepID,ManagerID) VALUES (?, ?, ?, ? , ?, ?, ?, ?, ?, ?, ?)");
